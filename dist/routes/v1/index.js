...
const subscription_routes_js_1 = __importDefault(require("./subscription.routes.js"));
const message_routes_js_2 = __importDefault(require("./message.routes.js"));
...
v1Routes.use('/subscriptions', subscription_routes_js_1.default);
v1Routes.use('/messages', message_routes_js_2.default);
v1Routes.use('/applications', application_routes_js_1.default);
