...
import { createContent, deleteContent, getContent, getContentList, getCreatorProfileContent, moderationUpdate, patchContent, } from "../../controllers/content.controllers.js";
const router = express.Router();
// POST /v1/content
router.post("/", authenticate, requireVerified, requireRole("CREATOR"), createContent);
// GET /v1/content
